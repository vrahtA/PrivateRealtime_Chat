...
function Lobby() {
  ...
  const wasEnded = searchParams.get("ended") === "true"
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        ...
        {wasEnded && (<div className="bg-red-950/50 border border-red-900 p-4 text-center">
        <p className="text-red-500 text-sm font-bold">
          ROOM ENDED
        </p>
        <p className="text-zinc-500 text-xs mt-1">
          All your previous chats were permanently deleted.
        </p>
        </div>)}
        ...
        <p className="text-zinc-500 text-xs mt-1">
          The room may have expired or doesn't exist.
        </p>
        </div>)}
        ...
        <p className="text-zinc-500 text-xs mt-1">
          The room you're trying to enter is already full.
        </p>
        </div>)}
